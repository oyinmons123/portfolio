        ...
        <div className="bg-black text-white py-8">
            <div className="container mx-auto px-8 md:px-16 lg:px-24">
                <div className="flex flex-col md:flex-row md:space-x-12 items-center mb-4"> 
                    <div className="flex-1 mb-4md:mb-0">
                    <h3 className="text-2xl font-bold mb-2">Yusuf</h3>
                    <p className="text-gray-400">Front-End Developer based in Kwara, specializing in web and softwaredevelopment</p>
                    </div>
                ...
                <div  className="border-t border-gray-600 pt-4 flex flex-col md:flex-row justify-between items-center">
                   ...
                   className="flex space-x-4 my-4 md:my-0">
                        ...
                        <a href="">
                            <FaMedium className="text-gray-400 hover:text-white"/>
                        </a>
                        <a href="">
